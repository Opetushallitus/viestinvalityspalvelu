CREATE UNLOGGED TABLE IF NOT EXISTS raportointi_cas_client_session (
...
CREATE UNIQUE INDEX IF NOT EXISTS raportointi_cas_client_session_ix1 ON raportointi_cas_client_session (mapped_ticket_id);

CREATE UNLOGGED TABLE IF NOT EXISTS lahetys_cas_client_session (
    mapped_ticket_id VARCHAR PRIMARY KEY,
...
CREATE UNIQUE INDEX IF NOT EXISTS lahetys_cas_client_session_ix1 ON lahetys_cas_client_session (mapped_ticket_id);
