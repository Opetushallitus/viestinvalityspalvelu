...
CREATE INDEX IF NOT EXISTS viestit_oikeudet_otsikko_sisalto_vastaanottajat_lahettaja_metadata_idx ON viestit USING GIN (haku_kayttooikeudet, haku_otsikko, haku_sisalto, haku_vastaanottajat, haku_lahettaja, haku_metadata);
