...
class SecurityOperaatiotTest {
  ...
  @Test def testKayttajanOikeudet(): Unit =
    ...
    Assertions.assertEquals(Set(Kayttooikeus(OIKEUS, Option.apply(ORGANISAATIO)), Kayttooikeus(OIKEUS, Option.apply("1.2.246.562.10.2014041814455745619200"))), securityOperaatiot.getKayttajanOikeudet())
