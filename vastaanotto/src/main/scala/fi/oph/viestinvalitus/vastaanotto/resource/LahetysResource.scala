...
import fi.oph.viestinvalitus.vastaanotto.model.{Lahetys, LahetysTunnisteIdentityProvider, LahetysValidator, LiiteTunnisteIdentityProvider, Viesti, ViestiValidator}
